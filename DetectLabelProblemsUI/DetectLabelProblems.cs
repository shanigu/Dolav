...
namespace DetectLabelProblems
{
    public partial class DetectionUI : Form
    {
        ...
        private void DetectionUI_Load(object sender, EventArgs e)
        {
            ...
            /*
            DirectoryInfo d = new DirectoryInfo(@"C:\Users\shanigu\Downloads\cam_EN3200\2023-02-07");
            foreach (DirectoryInfo dSub in d.GetDirectories())
            {
                ImageComparator comp = new ImageComparator();
                comp.ReferenceImage = @"C:\Users\shanigu\Downloads\cam_EN3200\2023-02-07\11-47-02\Image_001.jpg";
                comp.NewImage = dSub.FullName + @"\Image_001.jpg";
                //ImageComparator.BlackThreshold = 80;
                ImageComparator.WhiteThreshold = 255;
        ...
        protected void NewFolderFound(object sender, ProgressChangedEventArgs e)
        {
            ...
            foreach (FileInfo file in dirRef.GetFiles("*.jpg"))
            {
                ...
                else
                {
                    ...
                    {
                        ImageComparator.ReferenceRectangleMarked = true;
                        ImageComparator.ReferenceRectangle = ImageReferenceRectangle[file.Name];
                    }
                    else
        ...
        private void mMain_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
